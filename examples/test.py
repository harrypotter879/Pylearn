import numpy as np
from pylearn.gradient_descent import MSELoss ,LinearModel ,Batch_gradient_Descent,RidgeLoss,Stocastic_Gradient_Descent
...
classifier = Stocastic_Gradient_Descent(
    learning_rate=0.001, 
    epochs=1000, 
